		...
		<div id="bottomfooter" <?php if($fclass != '') { echo 'class="'. $fclass .'"'; } ?> >		
			<div class="centered-wrapper">	
				...
				<div class="percent-one-third column-last">
					<ul id="social">
						<?php
							$social_links = array('rss','facebook','twitter','flickr','google-plus', 'dribbble' , 'linkedin', 'pinterest', 'youtube', 'github-alt', 'vimeo-square', 'instagram', 'tumblr', 'behance', 'vk', 'xing', 'soundcloud');
							if($social_links) {
